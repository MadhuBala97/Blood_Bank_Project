...
urlpatterns =[
    ...
    path('delete_user/', include('application.urls')),
    path('updateuser/', include('application.urls')),
    path('savedata/', include('application.urls')),
    path('showbloodbank/', include('application.urls')),
    path('bloodbankcode/', include('application.urls')),
]
